    ...
    <div className={styles.container}>
      ...
      <div className={richStyles.richText}>
        <p className={styles.paragraph}>
          ...
          <strong>web development / eCommerce site manager</strong> position. If you&rsquo;re here
          to check out my web work, or grab my resume, please use the links below. If you think
