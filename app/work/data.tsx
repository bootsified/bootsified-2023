...
export const projects = [
  ...
  },
  {
    ...
    skills: ['HTML', 'CSS', 'JS', 'CraftCMS', 'Twig'],
    notes:
      '<p>One of the big clients we had when I was working at Switch was the <strong>Gladney Center for Adoption</strong>, and this is their main website.  Switch\'s design for the site was another knockout, and once again, I was able to stretch my legs a bit with the development.  It\'s a MASSIVE site, with a custom CMS built with CraftCMS.  This was by far the most intense CMS build I\'ve had, but it all turned out great.  The site is still in use today (2023)</p>\
    <p>A couple of the highlights of this site are the <a href="https://adoptionsbygladney.com/i-want-to-adopt" target="_blank">"What kind of adoption is right for me?" questionaire</a>, and the fun timeline-style layout of <a href="https://adoptionsbygladney.com/about/history-timeline" target="_blank">their history page</a>.</p>',
  },
  {
    id: 'dock-bass-solo',
  ...
  },
  {
    ...
    skills: ['HTML', 'CSS', 'JS', 'ExpressionEngine'],
    notes:
      '<p><strong>Hinge Analytics</strong> was a... well, I\'m not actually sure what they were.  Something about "consulting" and "results", with a ton of generic biz-speak in between.  Fortunately for me, they wanted a website that would really stand out, and Switch and I gave them one.</p>\
    <p>From the looping, fullscreen background video of a chimpanzee pounding on a computer for the homepage, to the bottom of this single-page scroller, it was nothing like what you\'d expect from a typical "analytics company".  The site was playful, top-to-bottom, which was a lot of fun for me to develop.  It also featured a custom CMS built with ExpressionEngine, so the client could update their biz-speak to their hearts desire.</p>\
    <p>OK... In all honesty, I LOVED this website, and the client was a total joy to work with, but since the company didn\'t last very long, it *might* not have been the best branding decision.  But hey, I\'m just the developer.  I leave the branding to the experts.</p>',
  },
  {
    id: 'see-you-today',
    title: 'See You Today',
    ...
    skills: ['Bass Guitar'],
    notes:
      "<p>The first real gigging band I was in was <strong>Interface</strong>, based in Dallas, TX.  We started in 1990 and quickly became one of the better known bands in the scene.  We later even had a song that got significant airplay on regional alt-rock stations, but weren't able to break through before things fell apart in 1994.  It's too bad...  we were pretty good.</p>\
    <p>This video was shot at the world-famous Southfork Ranch (home of the Ewings from TV's <em>Dallas</em>), where we were the headliner for the 1990 SMU homecoming celebration.  Sure... laugh all you want.  But we looked and sounded pretty fly for 1990.  This was probably the biggest crowd I'd played for at the time, so you can practically see the stage fright in my eyes.  Assuming you can peel you eyes away from my badass bolo tie and tux shirt, under the oversized blazer with rolled up sleeves.  Grrrr, baby!</p>",
  },
  {
    ...
    <p>Well, he declined the site.  He never really said why, but just that he wasn't interested, which is totally his prerogative. So now it's just a neat little side project I made that will never get used.</p>\
  ...
  },
  {
    ...
    skills: ['HTML', 'CSS', 'JS', 'ExpressionEngine'],
    notes:
      '<p>One of the big clients we had when I was working at Switch was the <strong>Gladney Center for Adoption</strong>.  This was their "Pregnancy Hotline" website, for pregnant women who needed help.  Switch\'s design for the site was another knockout, and once again, I was able to stretch my legs a bit with the development.  The site actually won a DSVC Bronze Award in 2016.</p>\
    <p>It features a custom CMS, built with ExpressionEngine.  We also integrated it with their primary CRM to pull in all the data for their prospective adoptive parents.  Women could come to the site and search through the hundreds of prospective families.  Once they found families that seemed like a good fit, they could message them and start a conversation.  I was SUPER proud of this website.  We were told by Gladney that they saw a major increase in contacts once this site launched.  That\'s what I love to hear.  :)</p>',
  },
  {
    id: 'new-years-day',
    title: 'New Years Day',
  ...
  },
  {
    ...
    <p>Sadly, this version of the site no longer exists, and I haven't been able to get an archive of the best parts of the site.</p>",
  },
]
